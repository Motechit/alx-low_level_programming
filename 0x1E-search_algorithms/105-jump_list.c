...
/**
 * get_n_next - It gets the nth node next to a given node
 * @node: This is the starting node
...
/**
 * jump_list - It searches for the  value in a sorted linked list using a jump search
 * @list: This is the linked list to search in
 * @size: This is the len of the linked list
 * @value: This is the value to look for in the array
 * Return: It returns the node with the value in the linked list, otherwise NULL
 */
